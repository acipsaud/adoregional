...
class Modadodashodpready extends CI_Model
{
	var $table = 'dataado'; //nama tabel dari database
    var $column_order = array(null, 'am','witel','nama_cust','alamat','det_kat','odp','lay_existing'); //field yang ada di table user
